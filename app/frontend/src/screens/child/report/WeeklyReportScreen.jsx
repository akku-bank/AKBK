        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                <View style={styles.summaryCard}>
                    ...
                    <CustomText style={styles.comparisonText}>저번 주보다 <CustomText style={styles.highlightRed}>3,000원</CustomText> 더 썼어요 📈</CustomText>
                </View>
                ...
                <View style={styles.aiReviewCard}>
                    ...
                    <CustomText style={styles.aiReviewText}>
                        "저번 주보다 지출이 조금 늘었네요! 특히 편의점 간식 구매가 많았어요. 다음 주에는 조금 아껴서 저축해보는 건 어떨까요?"
                    </CustomText>
                </View>
...
const styles = StyleSheet.create({
    ...
    aiReviewCard: { backgroundColor: '#F0FDF4', padding: scale(20), borderRadius: scale(16), marginBottom: verticalScale(16) },
